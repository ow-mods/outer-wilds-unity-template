...
public class NoclipCameraController : MonoBehaviour
    {
        ...
        [Tooltip("Base speed factor, can be controlled with the mouse wheel.")]
        ...
        public bool EscapeClosesApp = true;
        ...
        void Update()
        {
            ...
            // Unscaled interpolation - Gets 99% of target location... Might add a slider to control this later.
